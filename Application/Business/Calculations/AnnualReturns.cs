...
namespace Application.Business.Calculations
{
    ...
    {
        public AnnualReturns(int testId, IEnumerable<Position> trades, double initialCapitalInvestment)
        {
        ...
        private double CalculateCapitalAtStartOfYear(IOrderedEnumerable<Position> trades, int upToButExcludingYear, double initialCapital)
        {
        ...
        private double CalculateMarginThisYearOnly(IOrderedEnumerable<Position> trades, int thisYear)
        {
