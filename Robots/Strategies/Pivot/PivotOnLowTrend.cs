...
namespace Robots.Strategies.Pivot
{
    public class PivotOnLowTrend : IStrategy
    {
        ...
        public PivotOnLowTrend(IMarketInfo props, ConfirmingSignals signals, double thresholdForTrade, 
